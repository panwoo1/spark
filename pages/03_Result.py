...
st.write(
    """
    - 서울시 내 승용차를 이용한 통행자를 대상으로 통행사슬 내 도착지점 유형을 직장, 학교, 기타로 구분해 **도착지점별 비중과 도착지에서의 평균 활동시간**을 분석한 결과  
    도착지점 유형 중 직장의 비중이 가장 높았습니다.
      - 승용차 이용 통행자 대부분이 직장인, 전기차의 잠재 수요층 역시 직장인이라는 의미
